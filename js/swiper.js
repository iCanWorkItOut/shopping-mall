const swiperMain = new Swiper('.swiper-container--main-banner', {
  ...
  pagination: {
    ...
    type: 'bullets', // 'bullets', 'fraction', 'custom'
    clickable: true,
  },
  navigation: {
...
const swiperBottom = new Swiper('.swiper-container--bot-banner', {
  slidesPerView: 2, // 한 화면에 들어오는 슬라이드 갯수
  spaceBetween: 20, // 슬라이드 간 여백
  debugger: true, // 드래그로 슬라이드 이동
  // mousewheel: true,
  loop: true,
  // loopAdditionalSlides: 1, // loop 생성 후 복제할 슬라이드 수 추가
  effect: 'slide', // 슬라이드 이동 효과 'slide', 'fade'
  /* fadeEffect: { // effect: 'fade' 설정
    crossFade: true,
  }, */
  speed: 700, // 슬라이드 속도
  ...
  pagination: {
    el: '.swiper-pagination--bot-banner',
    type: 'fraction', // 'bullets', 'fraction', 'custom'
    clickable: true,
  },
  // navigation: {
  //   nextEl: '.swiper-button-next--bot-banner',
  //   prevEl: '.swiper-button-prev--bot-banner',
  // },
});
